...
function haveFood(unit) {
    ...
    if (unit_classes.includes('food-unit')) {
        ...
        showScore.innerHTML = 'Текущий счет: ' + score;
        var divButtons = document.getElementsByClassName('buttons')[0];
        divButtons.appendChild(showScore);
    }
    return check;
}
...
function createBomb() {
    ...
    while (!bombCreated) { //пока бомбочку не создали
        // рандом
